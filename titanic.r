...
# Create new variable: Title which is the passengers title
test$Survived <- NA
...
# Create a var for family size by adding siblings, spouses, parents, children, self
...
my_forest <- randomForest(as.factor(Survived) ~ Pclass + Sex + Age + famSize
